...
def get_patrol_summary_report_data():
	"""
	Generate patrol summary report data.
	"""
	...
	report_data = {
		"summary": {
			...
			"completion_rate": round((completed_schedules / total_schedules * 100) if total_schedules > 0 else 0, 2),
			"total_verifications": total_verifications,
			"verifications_with_discrepancies": verifications_with_discrepancies,
			"discrepancy_rate": round((verifications_with_discrepancies / total_verifications * 100) if total_verifications > 0 else 0, 2),
